...
namespace timoo_pointcloud
{
    ...
    diagnostics_(node, private_nh, node_name)
  {
    ...
    tf_filter_ptr_ = boost::shared_ptr<tf::MessageFilter<timoo_msgs::timooScan> >(
            new tf::MessageFilter<timoo_msgs::timooScan>(timoo_scan_, *tf_ptr_, config_.target_frame, 10));
   ...
   */
  void
    Transform::processScan(const timoo_msgs::timooScan::ConstPtr &scanMsg)
  {
